...
if len(sys.argv) <= 1:
    print 'tools ini untuk wpbf ya adick adick'
    print 'jadi kalo ada apa apa bilang ama MR.R07'
    print 'klo mau hubungi gua wa aja 0895341322341'
    print 'Website: http://tools-medancyberteam.site'
    print 'Mail   : mrwgaming0@gmail.com'
    print ''
...
try:
    ...
    #Finish
    print ''       
    print '1 target successfuly completed, '+ str(countAcc) +'dah kelar beb'
    print 'TARGET: ' + url
    print 'hasil lu:'        
    print result
    sys.exit()
except urllib2.URLError, e:
    print "\n\t[!] Session Cancelled; eror cuk. internet lu lag asw"
